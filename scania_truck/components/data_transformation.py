...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        logger.info("Entered get_data_transformer_object method of Data_Ingestion class")
    ...
    def initiate_data_transformation(self, train_set, test_set):
        logger.info("Entered initiate_data_transformation method of Data_Transformation class")
        ...
        try:
            ...
            target_feature_train_df = target_feature_train_df.replace({'pos': 1, 'neg': 0})
            ...
            target_feature_test_df = target_feature_test_df.replace({'pos': 1, 'neg': 0})
            ...
            logger.info("Used the preprocessor object to fit transform the train features")
            ...
            preprocessor_obj_file_name = (self.artifacts_dir + "/" + "scania_truck_preprocessor" + ".pkl")

            self.utils.save_object(preprocessor_obj_file_name, preprocessor)

            logger.info("Saved the preprocessor object")

            logger.info("Exited initiate_data_transformation method of Data_Transformation class")
