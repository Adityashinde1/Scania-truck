...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_set, test_set):
        ...
        try:
            ...
            (best_model, best_model_score) = self.utils.get_best_model_with_name_and_score(lst)
            ...
            if best_model_score >= base_model_score:
                ...
                scania_truck_model = ScaniaTruckModel(preprocessing_object=preprocessing_obj, trained_model_object=best_model)

                logger.info("Created scania truck model object with preprocessor and model")
